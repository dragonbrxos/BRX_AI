# BRX AI - Modelo de IA Leve para Arch Linux
...
Após a instalação, basta digitar `brx` no seu terminal para iniciar uma conversa interativa com a IA. O BRX analisará cada caractere da sua entrada para fornecer a resposta mais precisa baseada em seu cérebro JSON.
